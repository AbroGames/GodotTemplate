using GodotTemplate.Scenes.Game.Network;
...
public class NetworkService : KludgeBox.Godot.Services.NetworkService
{
    ...
    /// Because in this situation game don't have outer controller.
    /// It works the same way as GetMultiplayer().IsServer() in Godot.<br/>
